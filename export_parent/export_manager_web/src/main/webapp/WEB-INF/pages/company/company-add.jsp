        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="/company/edit.do" method="post" class="uk-form">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
<%--                        <input type="number" class="form-control" placeholder="余额" name="balance" value="${company.balance}">--%>
                        <input type="text"  onkeyup = "value=value.replace(/[^\d]/g,'')" class="form-control" placeholder="余额" name="balance" value="${company.balance}">
                    </div>
