    ...
    <section class="content">
        <form id="editForm" action="${ctx}/cargo/invoice/edit.do" method="post">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">编辑发票</div>
                <%--enctype="multipart/form-data"--%>
                <%--<input type="hidden" name="financeNo" value="${financeNo}">--%>

                <%-- <div class="row data-type" style="margin: 0px">
                     &lt;%&ndash;<div class="col-md-2 title">财务报运单号</div>
                     <div class="col-md-4 data">
                         <input type="text" class="form-control" placeholder="财务报运单号" name="id"
                                value="${finance.id}"/>
                     </div>&ndash;%&gt;
