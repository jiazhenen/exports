...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="${ctx}/system/userfeedback/list.do">反馈列表</a></li>
        </ol>
    </section>
    <!-- 内容头部 /-->
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/system/userfeedback/edit.do" method="post">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <select class="form-control"  name="classType">
                            ...
                            <option ${requestScope.feedback.classType == '1' ?'selected':''} value="1">管理</option>
                            <option ${requestScope.feedback.classType == '2' ?'selected':''} value="2">安全</option>
                            <option ${requestScope.feedback.classType == '3' ?'selected':''} value="3">建议</option>
                            <option ${requestScope.feedback.classType == '4' ?'selected':''} value="4">其他</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <select class="form-control"  name="difficulty">
                            <option value="">请选择</option>
                            <option ${requestScope.feedback.difficulty == '1' ?'selected':''} value="1">极难</option>
                            <option ${requestScope.feedback.difficulty == '2' ?'selected':''} value="2">比较难</option>
                            <option ${requestScope.feedback.difficulty == '3' ?'selected':''} value="3">有难度</option>
                            <option ${requestScope.feedback.difficulty == '4' ?'selected':''} value="4">一般</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <select class="form-control"  name="isShare">
                            <option value="">请选择</option>
                            <option ${requestScope.feedback.isShare == '1' ?'selected':''} value="1">公开</option>
                            <option ${requestScope.feedback.isShare == '0' ?'selected':''} value="0">不公开</option>
                        </select>
                    </div>
